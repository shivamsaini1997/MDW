...
useEffect(() => {
  function handleScroll() {
    ...
    // Show the nav bar only when scroll position is greater than 300px
    setIsNavVisible(currentScrollPos < 600);
    ...
    if (currentScrollPos < 10) {
      setActiveTab('Home');
    } else if (currentScrollPos >= 10 && currentScrollPos < about.offsetTop - 10) {
      setActiveTab('About');
    } else if (currentScrollPos >= about.offsetTop - 10 && currentScrollPos < learn.offsetTop - 10) {
      setActiveTab('learn');
    } else if (currentScrollPos >= learn.offsetTop - 10 && currentScrollPos < contributor.offsetTop - 10) {
      setActiveTab('Contributor');
    } else if (currentScrollPos >= contributor.offsetTop - 10 && currentScrollPos < faq.offsetTop - 10) {
      setActiveTab('FAQ');
    }
  }
    ...
    <div className="container-fluid mt-5 ps-0 orgprofile">
        <div className="row">
            ...
            <div className="col-lg-10">
                <nav className="breadcrumbox" style={{ '--bs-breadcrumb-divider': '>' }} aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item " aria-current="page">Savings <span><svg width="7" height="7" viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0.6 5.672L5.124 3.788L0.6 1.64V0.704L6.252 3.524V4.124L0.6 6.608V5.672Z" fill="black"/>
                            </svg></span></li>
                        <li className="breadcrumb-item " aria-current="page">Make Money <span></span></li>
                    </ol>
                </nav>
                            ...
                            <div className="modulnamefoureboc">
                                <span className="">
                                    <svg width="42" height="40" viewBox="0 0 42 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M41.2266 21.4651C41.2266 19.1482 39.3186 17.1721 36.9336 17.1721H36.4566V4.29302C36.4566 1.90801 34.5486 0 32.1635 0H4.29302C1.90801 0 0 1.90801 0 4.29302V23.9864C0 26.3714 1.90801 28.2794 4.29302 28.2794H11.9932C12.0613 28.4157 12.1295 28.4838 12.1976 28.6201C11.5843 29.3697 11.1755 30.3237 11.1755 31.3458V35.707C11.1755 38.0238 13.0835 40 15.4685 40H36.9336C39.2504 40 41.2266 38.092 41.2266 35.707V31.3458C41.2266 30.3237 40.8859 29.3697 40.2044 28.6201C40.8177 27.8705 41.2266 26.9165 41.2266 25.8944V21.4651ZM38.1601 21.4651V25.8262C38.1601 26.5077 37.615 27.0528 36.9336 27.0528H15.4685C14.7871 27.0528 14.2419 26.5077 14.2419 25.8262V21.4651C14.2419 20.7836 14.7871 20.2385 15.4685 20.2385H34.8893C34.8893 20.2385 34.8893 20.2385 34.9574 20.2385C35.0256 20.2385 34.9574 20.2385 35.0256 20.2385H36.9336C37.615 20.3066 38.1601 20.7836 38.1601 21.4651ZM33.3901 4.29302V9.19932H27.4617L31.2095 3.06644H32.1635C32.845 3.06644 33.3901 3.61158 33.3901 4.29302ZM18.4668 3.06644L14.7189 9.19932H9.13118L12.879 3.06644H18.4668ZM22.0102 3.06644H27.598L23.8501 9.19932H18.2624L22.0102 3.06644ZM4.29302 3.06644H9.26746L5.51959 9.19932H3.06644V4.29302C3.06644 3.61158 3.61158 3.06644 4.29302 3.06644ZM3.06644 23.9864V12.2658H33.3901V17.2402H15.4685C13.1516 17.2402 11.1755 19.1482 11.1755 21.5332V25.2811H4.29302C3.61158 25.2129 3.06644 24.6678 3.06644 23.9864ZM38.1601 35.707C38.1601 36.3884 37.615 36.9336 36.9336 36.9336H15.4685C14.7871 36.9336 14.2419 36.3884 14.2419 35.707V31.3458C14.2419 30.6644 14.7871 30.1193 15.4685 30.1193H36.9336C37.615 30.1193 38.1601 30.6644 38.1601 31.3458V35.707Z" fill="url(#paint0_linear_1778_22426)"/>
                                        <path d="M18.6024 22.0156C17.7847 22.0156 17.0352 22.6971 17.0352 23.5829V23.6511C17.0352 24.4688 17.7166 25.2184 18.6024 25.2184C19.4883 25.2184 20.1697 24.5369 20.1697 23.6511V23.5829C20.1016 22.6971 19.4202 22.0156 18.6024 22.0156Z" fill="url(#paint1_linear_1778_22426)"/>
                                        <path d="M34.8904 22.0703H31.7558C30.9381 22.0703 30.1885 22.7517 30.1885 23.6376C30.1885 24.5235 30.8699 25.2049 31.7558 25.2049H34.8904C35.7081 25.2049 36.4576 24.5235 36.4576 23.6376C36.4576 22.7517 35.7762 22.0703 34.8904 22.0703Z" fill="url(#paint2_linear_1778_22426)"/>
                                        <path d="M18.6024 31.8281C17.7847 31.8281 17.0352 32.5096 17.0352 33.3954V33.4636C17.0352 34.2813 17.7166 35.0308 18.6024 35.0308C19.4883 35.0308 20.1697 34.3494 20.1697 33.4636V33.3954C20.1016 32.5096 19.4202 31.8281 18.6024 31.8281Z" fill="url(#paint3_linear_1778_22426)"/>
                                        <path d="M34.8904 31.8828H31.7558C30.9381 31.8828 30.1885 32.5642 30.1885 33.4501C30.1885 34.336 30.8699 35.0174 31.7558 35.0174H34.8904C35.7081 35.0174 36.4576 34.336 36.4576 33.4501C36.4576 32.5642 35.7762 31.8828 34.8904 31.8828Z" fill="url(#paint4_linear_1778_22426)"/>
                                        <defs>
                                            <linearGradient id="paint0_linear_1778_22426" x1="41.2266" y1="6.26506" x2="10.7384" y2="36.7833" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="#46C898"/>
                                                <stop offset="1" stop-color="#4FD26A"/>
                                            </linearGradient>
                                            <linearGradient id="paint1_linear_1778_22426" x1="20.1697" y1="22.5173" x2="17.7317" y2="24.8347" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="#46C898"/>
                                                <stop offset="1" stop-color="#4FD26A"/>
                                            </linearGradient>
                                            <linearGradient id="paint2_linear_1778_22426" x1="36.4576" y1="22.5613" x2="34.513" y2="26.3385" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="#46C898"/>
                                                <stop offset="1" stop-color="#4FD26A"/>
                                            </linearGradient>
                                            <linearGradient id="paint3_linear_1778_22426" x1="20.1697" y1="32.3298" x2="17.7317" y2="34.6472" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="#46C898"/>
                                                <stop offset="1" stop-color="#4FD26A"/>
                                            </linearGradient>
                                            <linearGradient id="paint4_linear_1778_22426" x1="36.4576" y1="32.3738" x2="34.513" y2="36.151" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="#46C898"/>
                                                <stop offset="1" stop-color="#4FD26A"/>
                                            </linearGradient>
                                        </defs>
            ...
            <section className="tabsopenmoduls">
                <div className="container-fluid">
                    <div className={` row nav1 nav-tabs mb-5 w-100 ${isNavVisible ? 'nav-visible' : 'nav-hidden'}`}>
                        <div className="col-lg-6">
                            <nav className={`nav nav-tabs`} id="nav-tab" role="tablist">
                                <button className={`nav-link ${activeTab === 'Home' ? 'active' : ''}`} id="Home-tab" data-bs-toggle="tab" data-bs-target="#Home" type="button" role="tab" aria-controls="Home" aria-selected="true">Home</button>
                                <button className={`nav-link ${activeTab === 'About' ? 'active' : ''}`} id="About-tab" data-bs-toggle="tab" data-bs-target="#About" type="button" role="tab" aria-controls="About" aria-selected="false">About</button>
                                <button className={`nav-link ${activeTab === 'learn' ? 'active' : ''}`} id="learn-tab" data-bs-toggle="tab" data-bs-target="#learn" type="button" role="tab" aria-controls="learn" aria-selected="false">What you will learn</button>
                                <button className={`nav-link ${activeTab === 'Contributor' ? 'active' : ''}`} id="Contributor-tab" data-bs-toggle="tab" data-bs-target="#Contributor" type="button" role="tab" aria-controls="Contributor" aria-selected="false">Contributor</button>
                                <button className={`nav-link ${activeTab === 'FAQ' ? 'active' : ''}`} id="FAQ-tab" data-bs-toggle="tab" data-bs-target="#FAQ" type="button" role="tab" aria-controls="FAQ" aria-selected="false">FAQ</button>
                            </nav>
                        </div>
                        <div className="col-lg-6">
                        <div  className={`btngroup mt-0 btnheadergroup`}  role="tablist">
                            <button class="btn btn-first1"><span>Add to Edit Panel</span></button>
                            <button class="btn btn-first3">See All Videos</button></div>
                        </div>
                    ...
                    <div className="row fiexdheader-da">
                             <div className="col-12">
                                ...
                                <div class="tab-pane marginBottom" id="About" role="tabpanel" aria-labelledby="About-tab" tabindex="0">
                                    <div className="row mb-5">
                                        <div className="col-md-6 text-center px-lg-5">
                                            <h3>About</h3>
                                            <p className="mb-0">Online e-commerce courses teach business management and marketing strategy skills, which are key to successfully operating an online business with an e-commerce storefront. </p>
                                            <p>Online e-commerce courses teach business management and marketing strategy skills, which are key to successfully operating an online business with an e-commerce storefront.</p>
                                        </div>
                                ...
                                <div class="tab-pane marginBottom" id="learn" role="tabpanel" aria-labelledby="learn-tab" tabindex="0">
                                    ...
                                    <div className="container-fluid">
                                        ...
                                        <div className="row">
                                           <div className="col-lg-3 col-md-6">
                                                <div className="learncards bgcards1">
                                                    <h5>Build an exciting, profitable</h5>
                                                        <p>Build an exciting, profitable. Build an exciting, profitable</p>
                                                </div>
                                           </div>
                                           <div className="col-lg-3 col-md-6">
                                                <div className="learncards bgcards2">
                                                    <h5>Build an exciting, profitable</h5>
                                                        <p>Build an exciting, profitable. Build an exciting, profitable</p>
                                                </div>
                                           </div>
                                           <div className="col-lg-3 col-md-6">
                                                <div className="learncards bgcards3">
                                                    <h5>Build an exciting, profitable</h5>
                                                        <p>Build an exciting, profitable. Build an exciting, profitable</p>
                                                </div>
                                           </div>
                                           <div className="col-lg-3 col-md-6">
                                                <div className="learncards bgcards4">
                                                    <h5>Build an exciting, profitable</h5>
                                                        <p>Build an exciting, profitable. Build an exciting, profitable</p>
                                                </div>
                                           </div>
                                        ...
                                        <div className="row mt-5">
                                            <div className="col-12 text-center mb-3">
                                                <h3>What course covers</h3>
                                            </div>
                                        </div>
                                        <div className="row coursecovers mb-5">
                                            <div className="col-lg-3 col-md-6">
                                                <div className="d-flex mb-3">
                                                    <span><svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M11.7543 0.807916L5.13703 6.8819L2.13424 4.10672C1.63377 3.63546 0.855269 3.68782 0.354803 4.10672C-0.145663 4.57798 -0.0900558 5.31104 0.354803 5.7823L3.91367 9.02874C4.24732 9.34292 4.69217 9.5 5.13703 9.5C5.58189 9.5 6.02675 9.34292 6.36039 9.02874L13.5337 2.53586C14.0342 2.0646 14.0342 1.33153 13.5337 0.860277C13.0333 0.389019 12.2548 0.38902 11.7543 0.807916Z" fill="#111928"/>
                                                        </svg>
                                                    </span>
                                                ...
                                                <div className="d-flex mb-3">
                                                    ...
                                                    <span className="ms-3">Platform Introduction</span>
                                                </div>
                                                <div className="d-flex mb-3">
                                                    <span><svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M11.7543 0.807916L5.13703 6.8819L2.13424 4.10672C1.63377 3.63546 0.855269 3.68782 0.354803 4.10672C-0.145663 4.57798 -0.0900558 5.31104 0.354803 5.7823L3.91367 9.02874C4.24732 9.34292 4.69217 9.5 5.13703 9.5C5.58189 9.5 6.02675 9.34292 6.36039 9.02874L13.5337 2.53586C14.0342 2.0646 14.0342 1.33153 13.5337 0.860277C13.0333 0.389019 12.2548 0.38902 11.7543 0.807916Z" fill="#111928"/>
                                                    ...
                                                    <span className="ms-3">Digital Tools</span>
                                                </div>
                                            </div>
                                            <div className="col-lg-3 col-md-6">
                                                <div className="d-flex mb-3">
                                                    ...
                                                    <span className="ms-3">Product Ideas</span>
                                                </div>
                                                <div className="d-flex mb-3">
                                                    <span><svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M11.7543 0.807916L5.13703 6.8819L2.13424 4.10672C1.63377 3.63546 0.855269 3.68782 0.354803 4.10672C-0.145663 4.57798 -0.0900558 5.31104 0.354803 5.7823L3.91367 9.02874C4.24732 9.34292 4.69217 9.5 5.13703 9.5C5.58189 9.5 6.02675 9.34292 6.36039 9.02874L13.5337 2.53586C14.0342 2.0646 14.0342 1.33153 13.5337 0.860277C13.0333 0.389019 12.2548 0.38902 11.7543 0.807916Z" fill="#111928"/>
                                                    ...
                                                    <span className="ms-3">Budgeting</span>
                                                </div>
                                                <div className="d-flex mb-3">
                                                    <span><svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M11.7543 0.807916L5.13703 6.8819L2.13424 4.10672C1.63377 3.63546 0.855269 3.68782 0.354803 4.10672C-0.145663 4.57798 -0.0900558 5.31104 0.354803 5.7823L3.91367 9.02874C4.24732 9.34292 4.69217 9.5 5.13703 9.5C5.58189 9.5 6.02675 9.34292 6.36039 9.02874L13.5337 2.53586C14.0342 2.0646 14.0342 1.33153 13.5337 0.860277C13.0333 0.389019 12.2548 0.38902 11.7543 0.807916Z" fill="#111928"/>
                                                    ...
                                                    <span className="ms-3">Finance</span>
                                                </div>
                                            </div>
                                            <div className="col-lg-3 col-md-6">
                                                <div className="d-flex mb-3">
                                                    ...
                                                    <span className="ms-3">Detail of Platforms</span>
                                                </div>
                                                <div className="d-flex mb-3">
                                                    <span><svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M11.7543 0.807916L5.13703 6.8819L2.13424 4.10672C1.63377 3.63546 0.855269 3.68782 0.354803 4.10672C-0.145663 4.57798 -0.0900558 5.31104 0.354803 5.7823L3.91367 9.02874C4.24732 9.34292 4.69217 9.5 5.13703 9.5C5.58189 9.5 6.02675 9.34292 6.36039 9.02874L13.5337 2.53586C14.0342 2.0646 14.0342 1.33153 13.5337 0.860277C13.0333 0.389019 12.2548 0.38902 11.7543 0.807916Z" fill="#111928"/>
                                                    ...
                                                    <span className="ms-3">Receive Payments</span>
                                                </div>
                                                <div className="d-flex mb-3">
                                                    <span><svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M11.7543 0.807916L5.13703 6.8819L2.13424 4.10672C1.63377 3.63546 0.855269 3.68782 0.354803 4.10672C-0.145663 4.57798 -0.0900558 5.31104 0.354803 5.7823L3.91367 9.02874C4.24732 9.34292 4.69217 9.5 5.13703 9.5C5.58189 9.5 6.02675 9.34292 6.36039 9.02874L13.5337 2.53586C14.0342 2.0646 14.0342 1.33153 13.5337 0.860277C13.0333 0.389019 12.2548 0.38902 11.7543 0.807916Z" fill="#111928"/>
                                                    ...
                                                    <span className="ms-3">Packaging</span>
                                                </div>
                                            </div>
                                            <div className="col-lg-3 col-md-6">
                                                <div className="d-flex mb-3">
                                                ...
                                                <div className="d-flex mb-3">
                                                    ...
                                                    <span className="ms-3">Expanding Business</span>
                                                </div>
                                                <div className="d-flex mb-3">
                                                    <span><svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M11.7543 0.807916L5.13703 6.8819L2.13424 4.10672C1.63377 3.63546 0.855269 3.68782 0.354803 4.10672C-0.145663 4.57798 -0.0900558 5.31104 0.354803 5.7823L3.91367 9.02874C4.24732 9.34292 4.69217 9.5 5.13703 9.5C5.58189 9.5 6.02675 9.34292 6.36039 9.02874L13.5337 2.53586C14.0342 2.0646 14.0342 1.33153 13.5337 0.860277C13.0333 0.389019 12.2548 0.38902 11.7543 0.807916Z" fill="#111928"/>
                                ...
                                <div class="tab-pane marginBottom Contributortabs" id="Contributor" role="tabpanel" aria-labelledby="Contributor-tab" tabindex="0">
                                        ...
                                        <div className="row mb-4 ">
                                            ...
                                            <div className="row align-items-center mb-5">
                                                <div className="col-lg-5">
                                                    <img className="Contributor-img" src="./images/Contributor.jpg" alt="" />
                                                </div>
                                                <div className="col-lg-7">
                                                    <div className="Contributor-col">
                                                        <h4>Radha</h4>
                                                            <p>Phd holder, Political Science </p>
                                                            <div className="mb-5">
                                                                <span>10 Modules, 2 Videos</span>
                                                                <span>1,200 Subscribers</span>
                                                            </div>
                                                        <p className="contributor-text">Build an exciting, profitable e-commerce business from scratch that can fund your life from anywhere on the planet! 35 FREE student-exclusive tools & resources. Build an exciting, profitable e-commerce business.</p>
                                                        <div className="d-flex gap-3 socialicon mb-5">
                                                        <img className="Contributor-img" src="./images/Linkedin.svg" alt="" />
                                                        <img className="Contributor-img" src="./images/Facebook.svg" alt="" />
                                                        <img className="Contributor-img" src="./images/instagram.svg" alt="" />
                                                        <img className="Contributor-img" src="./images/Youtube.svg" alt="" />

                                                        </div>
                                                        <button class="btn btn-first3 " style={{ width: '40%' }}>Subscribe</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-md-6 faqBox">
                                                <Accordion defaultActiveKey="0">
                                                    ...
                                                    <Accordion.Item eventKey="1">
                                                        <Accordion.Header>FAQ Question 2</Accordion.Header>
                                                        <Accordion.Body>
                                                        FAQ Answer 2
                                                        </Accordion.Body>
                                                    </Accordion.Item>
                                                    <Accordion.Item eventKey="2">
                                                        <Accordion.Header>FAQ Question 3</Accordion.Header>
                                                        <Accordion.Body>
                                                        FAQ Answer 3
                                                        </Accordion.Body>
                                                    </Accordion.Item>
