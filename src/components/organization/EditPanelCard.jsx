                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="d-flex mb-5">
                                                <div className="search-container position-relative w-100 videosearcheditpanel">
                                                    <form>
                                                        <input class="form-control" type="text" placeholder="Search Videos" autocomplete="off" />
                                                        ...
                                                        <div className="col-lg-4">
                                                            <div className="editvideocardsBox">
                                                                <div className="videobox position-relative">
                                                                    ...
                                                                    <span className="labletagtime"><img style={{width:'21px'}} src="../images/ion_time-outline.svg" alt="" /> Will be Deleted 7 days</span>
                                                                </div>
                                                                <div className="videoTextbox">
                                                                    <div className="d-flex justify-content-between">
                                                                        <p style={{width: '240px'}}>Navigating the Digital Landscape : A Comprehensive Guide to E Commerce Success</p>
                                                                    ...
                                                                    <span className="edittime mb-5">Edited : 43 minutes ago</span>
                                                                    <button class="btn btn-first1 w-100 mt-3"><span><img style={{width:'16px'}} src="../images/editvideo.svg" alt="" />Edit Video</span></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-lg-4">
